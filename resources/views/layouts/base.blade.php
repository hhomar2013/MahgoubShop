...
<link rel="stylesheet" href="{{ asset('assets/css/loader.css') }}"></head>
    @if(App::getLocale() == 'ar')
...
<body>
    @include('layouts.utility.header')
    @include('layouts.utility.mobile_header')

    {{ $slot }}

    @include('layouts.utility.footer')
    <!-- Vendor JS-->
