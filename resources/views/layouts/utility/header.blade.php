                        ...
                        <ul>
                            <li>
                                <a class="language-dropdown-active" href="#"> <i class="fi-rs-world">
                                    </i> {{ LaravelLocalization::getCurrentLocaleNative()  }} <i class="fi-rs-angle-small-down"></i>
                                </a>
            ...
            <div class="header-wrap header-space-between position-relative">
                ...
                <div class="header-nav d-none d-lg-flex">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        ...
                        <nav >
                            <ul>
                                <li><a class="{{ request()->routeIs('home') ? 'active' :'' }}" href="/">{{ __('Home') }}</a></li>
                                {{-- <li><a href="about.html">About</a></li> --}}
                                <li><a class="{{ request()->routeIs('shop') ? 'active' :'' }}" href="{{ route('shop') }}">{{ __('Shop') }}</a></li>
                                <li class="position-static"><a href="#">{{ __('Our Collections') }} <i class="fi-rs-angle-down"></i></a>
                                    <ul class="mega-menu">
