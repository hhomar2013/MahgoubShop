                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <div class="row product-grid-3">
                            @php
                                $wiItems = Cart::instance('wishlist')->content()->pluck('id');
                            @endphp
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-badges product-badges-position product-badges-mrg">
                                            @if (Carbon\Carbon::parse($product->created_at)->format('Y-m-d') == Carbon\Carbon::now()->format('Y-m-d'))
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-price">
                                            ...
                                            <span class="old-price">{{ $product->regular_price * 10/100 + $product->regular_price }}</span>
                                        </div>
                                        <div class="product-action-1 show position-static float-end py-2">
                                            @if ($wiItems->contains($product->id))
