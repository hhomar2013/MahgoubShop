                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">EGP {{ $products->regular_price }}</span></ins>
                                                <ins><span class="old-price font-md ml-15">EGP {{ $products->regular_price * 25/100 + $products->regular_price }}.00</span></ins>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{ route('product.details' ,['slug'=>$related->slug]) }}" tabindex="0">
