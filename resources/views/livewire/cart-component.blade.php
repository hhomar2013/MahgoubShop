                                ...
                                <tbody>
                                    @if (Session::has('success_massage'))
                                        {{-- <div class="alert alert-success">
                                            <strong>Success | {{ Session::get('success_massage') }}</strong>
                                        </div> --}}

                                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                            <strong>Done!</strong> {{ Session::get('success_massage') }}
                                    ...
                                    @foreach (Cart::instance('cart')->content() as $items)
                                        <tr>
                                            ...
                                            <td class="product-des product-name">
                                                <h5 class="product-name"><a href="">{{ $items->model->name }}</a></h5>
                                                {{-- <p class="font-xs">Maboriosam in a tonto nesciung eget<br> distingy magndapibus. --}}
                                                </p>
                                            </td>
                                            <td class="price" data-title="Price"><span>{{'EGP'. $items->model->regular_price }} </span></td>
                                            <td class="text-center" data-title="Stock">
                                                <div class="detail-qty border radius  m-auto">
                                                    <a href="#" class="qty-down" wire:click.prevent="decreaseQty('{{ $items->rowId }}')"><i class="fi-rs-angle-small-down"></i></a>
                                                    <span class="qty-val">{{ $items->qty }}</span>
                                                    <a href="#" class="qty-up" wire:click.prevent="increaseQty('{{ $items->rowId }}')"><i class="fi-rs-angle-small-up"></i></a>
                                                </div>
                                            </td>
                                            <td class="text-right" data-title="Cart">
                                                <span>{{$items->subtotal}} </span>
                                            </td>
                                            <td class="action" data-title="Remove"><a href="#" class="text-muted" wire:click.prevent="deleteItem('{{ $items->rowId }}')"><i class="fi-rs-trash"></i></a></td>
                                        </tr>
                                    @endforeach
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center text-danger">
                                            <a href="#" class="text-muted">No item data</a>
                                        </td>
                                    </tr>
                                    @endif
